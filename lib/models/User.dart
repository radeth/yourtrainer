...
class User extends Model {
  ...
  const User._internal({required this.id, email, accountType, createdAt, updatedAt}): _email = email, _accountType = accountType, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory User({String? id, String? email, String? accountType}) {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'email': _email, 'accountType': _accountType, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
